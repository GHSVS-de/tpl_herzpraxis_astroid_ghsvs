<?php
/*
Das Verhalten der Logos ist extrem nervend. Deshalb Reduzierung des sticky Logo
auf 1 mit 1 CSS-Klasse. Statt zuvor 3.
*/
...
<?php if ($logo_type == 'image')
{
	...
	// Im Normalfall wird das $headerLogo = $stickey_header_logo sein.
	if (!empty($stickey_header_logo))
	{
