...
?>
<div class="offcanvas offcanvas-end" tabindex="-1" id="<?php echo $modalId; ?>"
	aria-labelledby="<?php echo $modalId; ?>Header">
  <div class="offcanvas-header bg-light">
    <h5 id="<?php echo $modalId; ?>Header">Hauptmenü</h5>
		<?php	echo LayoutHelper::render('ghsvs.closeButtonTop',
			['options' => ['dismissType' => 'offcanvas']]); ?>
  </div>
  <div class="offcanvas-body">
		<?php
			echo HTMLHelper::_('bs3ghsvs.rendermodules', 'offcanvasContentDummyGhsvs');
		?>
	</div>
</div><!--/offcanvas-->
