...
?>
<?php if (!empty($pages)) : ?>
	<nav class="pagination__wrapper text-<?php echo $align; ?>"
		aria-label="<?php echo Text::_('JLIB_HTML_PAGINATION'); ?>">
			...
			<?php if ($showPagesLinks) : ?>
				<ul class="pagination flex-wrap justify-content-<?php echo $align; ?>">
			...
			<?php if ($showLimitStart) : ?>
				<!--
				$list['limitstart']:
				Das ist das aktuelle ?start=xyz, das im zugehörigen Pagination-Link
				angezeigt würde, wenn der Link angezeigt würde. Was er aber auf der
				jeweils aktiven Seite nicht wird.-->
